...
static constexpr const auto& kPrefsMetricsInstallDuration =
    "metrics-install-duration";
static constexpr const auto& kPrefsMetricsVerifyingDuration =
    "metrics-verifying-duration";
